...
MAX_RETRIES = 3
RETRY_DELAY = 2
START_BATCH = 1  # Continue from this batch (1-indexed)
...
with open(r'C:\Users\HP\Desktop\projects\HalalOne\canonical_products\canonical_products.json',"r", encoding="utf-8") as f:
    data = json.load(f)
